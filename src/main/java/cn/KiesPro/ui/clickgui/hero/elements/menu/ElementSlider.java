...
public class ElementSlider extends Element {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		 ...
		 * Den Slider rendern
		 */
		RenderUtil.drawRect(x, y + 12, x + width, y + 13.5, 0xff101010);
		RenderUtil.drawRect(x, y + 12, x + (percentBar * width), y + 13.5, color);
		
		if(percentBar > 0 && percentBar < 1)
		RenderUtil.drawRect(x + (percentBar * width)-1, y + 12, x + Math.min((percentBar * width), width), y + 13.5, color2);
